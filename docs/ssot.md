...
Version 1.28.0. Update this file in the same commit as any change it describes.
...
| --- | --- |
| `index.php` | `define('FOLIO_VERSION', '1.28.0.1');` |
| `changelog.md` | `## 1.28.0.1 — 13 August 2026` |
| `readme.txt` | `Stable tag: 1.28.0.1` |
| `readme.md` | `1.28.0.` under `## Version` |
| `security.md` | `The current supported release is **1.28.0.1**.` |
...
| `?action=feed_json` | JSON Feed v1.1 of recent documents; references llms.txt |
...
`/sitemap-pdf.xml`, `/sitemap-categories.xml`, `/feed.json`, `/llms.txt`, and
